...
Don't want to build from source? Get the signed installer, lifetime updates and setup support for a one-time payment at [onetimesuite.com/billoop](https://onetimesuite.com/billoop/) — same app, MIT source right here.
